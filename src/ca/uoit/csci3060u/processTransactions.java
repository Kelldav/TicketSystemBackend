...
public class processTransactions{
	private ArrayList<Transaction> transactionList;	//Arraylist that will contain all the transactions from mergedtransactions


	/**
	*Scans the merged transaction file and outputs the information
	*@param filename - Text file containing the merged transactions.
	* XX_UUUUUUUUUUUUUUU_TT_CCCCCCCCC (01-create, 02-delete, 06-addCredit, 00-end of session)
	* XX_UUUUUUUUUUUUUUU_SSSSSSSSSSSSSSS_CCCCCCCCC (05-refund)
	* XX_EEEEEEEEEEEEEEEEEEE_SSSSSSSSSSSSS_TTT_PPPPPP (03-sell, 04-buy)
	...
	*/
	...
	/**
	*Pad the event information to follow correct format of available tickets file
	*/
	...
	/**
	*Pad the user's information to follow correct format of current users accounts
	*/
	void padUser(){
