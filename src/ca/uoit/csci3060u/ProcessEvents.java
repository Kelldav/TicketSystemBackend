...
public class ProcessEvents {
    ...
    /**
     * This method returns a list of all the events in the availableTickets.txt file.
     * @return this.eventList - A list of all the events in the availableTickets.txt file.
     */
